        ...
        <div class="control container">
            <div class="select ">
                <select name="type_appointments_id" id="type_appointments_id">
                    ...
                    <option>Select dropdown</option>
                    <option value="2" <?= htmlentities(isset($type_appointments_id) && $type_appointments_id == 2 ? 'selected' : '') ?>>
                        APK keuring
                    </option>
                    <option value="2" <?= htmlentities(isset($type_appointments_id) && $type_appointments_id == 2 ? 'selected' : '') ?>>
                        Ruitschade
...
<div class="field container is-one-third">
    ...
    <div class="field container is-one-third">
        ...
        <div class="control">
            <input class="input" id="name" type="text" name="name" placeholder="Layla"
...
<div class="field container is-one-third">
    ...
    <div class="control">
        <input class="input" id="telephone" type="number" name="telephone" placeholder="+31 6 123 456 890"
               value="<?= htmlentities($telephone ?? '') ?>"/>
    </div>
